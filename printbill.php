...
?>
<head>
<link rel="shortcut icon" type="image/png" href="assets/img/images.jpg.png">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <ul class="nav navbar-nav">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">  <span class="caret"></span> </a>
                <ul class="dropdown-menu">
              <li> <a href="entercar.php">Add Machinery</a></li>
              <li> <a href="enterdriver.php"> Add Hirer</a></li>
              <li> <a href="clientview.php">View</a></li>
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Hire profile <span class="caret"></span> </a>
              ...
              <li> <a href="mybookings.php"> My Hires</a></li>
            </ul>
            </li>
          </ul>
                    <li>
...
$sql0 = "SELECT rc.id, rc.rent_end_date, rc.charge_type, rc.rent_start_date, c.car_name, c.car_nameplate FROM hiredmachinery rc, machinery c WHERE id = '$id' AND c.car_id = rc.car_id";
...
if($charge_type == "days"){
    ...
    $sql1 = "UPDATE hiredmachinery SET car_return_date='$car_return_date', no_of_days='$no_of_days', total_amount='$total_amount', return_status='$return_status' WHERE id = '$id' ";
} else {
    $distance = $distance_or_days;
    $sql1 = "UPDATE hiredmachinery SET car_return_date='$car_return_date', distance='$distance', no_of_days='$duration', total_amount='$total_amount', return_status='$return_status' WHERE id = '$id' ";
}

$result1 = $conn->query($sql1);

if ($result1){
     $sql2 = "UPDATE machinery c, hirer d, hiredmachinery rc SET c.car_availability='yes', d.driver_availability='yes' 
...
?>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center" style="color: green;"><span class="glyphicon glyphicon-ok-circle"></span> Machinery Returned</h1>
        </div>
    </div>
    <br>

    <h2 class="text-center"> Thank you for visiting Holiness Farm Machinery Hire company! We wish you have a safe usage. </h2>
    ...
    <div class="container">
        ...
        <div class="box">
            ...
            ?></h4>
                ...
                <br>
                <h4> <strong>Machinery Return Date: </strong> <?php echo $car_return_date; ?> </h4>
                <br>
